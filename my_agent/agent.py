...
#     await init_session(service, "weather_app", "user1", "session1")

#     runner = Runner(agent=agent, app_name="weather_app", session_service=service)

#     print(await call_agent_async("Hello!", runner, "user1", "session1"))
#     print(await call_agent_async("Weather in London", runner, "user1", "session1"))
